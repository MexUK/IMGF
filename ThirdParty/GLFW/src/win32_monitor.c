    ...
    *count = 0;
    ...
    for (adapterIndex = 0;  ;  adapterIndex++)
    {
        ...
        for (displayIndex = 0;  ;  displayIndex++)
        {
            ...
            wcscpy_s(monitor->win32.adapterName, wcslen(adapter.DeviceName), adapter.DeviceName); // edited
			wcscpy_s(monitor->win32.displayName, wcslen(display.DeviceName), display.DeviceName); // edited
