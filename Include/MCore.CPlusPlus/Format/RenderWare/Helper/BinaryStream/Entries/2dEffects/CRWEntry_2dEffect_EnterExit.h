...
class bxa::CRWEntry_2dEffect_EnterExit : public bxa::C2dEffect
{
public:
	...
	void							setMarkerApporximationRadius(bxa::CVector2D& vecMarkerApporximationRadius) { m_vecMarkerApporximationRadius = vecMarkerApporximationRadius; }
	bxa::CVector2D&						getMarkerApporximationRadius(void) { return m_vecMarkerApporximationRadius; }

	void							setExitMarkerPosition(bxa::CVector3D& vecExitMarkerPosition) { m_vecExitMarkerPosition = vecExitMarkerPosition; }
	bxa::CVector3D&						getExitMarkerPosition(void) { return m_vecExitMarkerPosition; }
...
private:
	...
	bxa::CVector2D						m_vecMarkerApporximationRadius; // The radius of the approximation to the marker X and Y
	bxa::CVector3D						m_vecExitMarkerPosition; // The position of exit - marker(offset relative to the object) (Always 0 ? )
