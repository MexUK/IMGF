...
class mcore::CIDEEntry_2DFX_Particle : public mcore::CIDEEntry_2DFX
{
public:
	CIDEEntry_2DFX_Particle(mcore::CIDEFormat *pIDEFormat) :
		CIDEEntry_2DFX(pIDEFormat, mcore::_2DFX_PARTICLE),
		m_uiParticleType(0),
		m_fSize(0.0f),
	...
	void						setStrength(mcore::CVector3D& vecStrength) { m_vecStrength = vecStrength; }
	mcore::CVector3D&					getStrength(void) { return m_vecStrength; }
	...
	void						setColour2(mcore::CVector3ui32& vecColour2) { m_vecColour2 = vecColour2; }
	mcore::CVector3ui32&				getColour2(void) { return m_vecColour2; }
...
private:
	...
	uint32						m_uiUnknown2;
	uint32						m_uiUnknown3;
	mcore::CVector3ui32				m_vecColour2;
};
