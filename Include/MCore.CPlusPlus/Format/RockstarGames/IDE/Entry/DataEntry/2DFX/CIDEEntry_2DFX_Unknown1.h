...
class mcore::CIDEEntry_2DFX_Unknown1 : public mcore::CIDEEntry_2DFX
{
public:
	CIDEEntry_2DFX_Unknown1(mcore::CIDEFormat *pIDEFormat) :
		CIDEEntry_2DFX(pIDEFormat, mcore::_2DFX_UNKNOWN_1),
		m_uiUnknown2(0),
	...
	void						setUnknown3(mcore::CVector3D& vecUnknown3) { m_vecUnknown3 = vecUnknown3; }
	mcore::CVector3D&					getUnknown3(void) { return m_vecUnknown3; }
