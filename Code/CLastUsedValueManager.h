...
class CLastUsedValueManager : public bxa::CManager
{
public:
	CLastUsedValueManager(void) :
		m_eLastUsedValue_Convert_IMGVersion(bxa::IMG_UNKNOWN),
		...
		m_eLastUsedValue_ConvertTXD_Game(bxa::PLATFORMED_GAME_UNKNOWN),
		m_pLastUsedValue_ConvertTXD_RasterDataFormat(nullptr),
		m_eLastUsedValue_Copy_IMGEntryProperty(bxa::IMG_ENTRY_ID),
		...
		m_eLastUsedValue_New_IMGVersion(bxa::IMG_UNKNOWN),
	...
	void								setLastUsedValue_Convert_IMGVersion(bxa::eIMGVersion eIMGVersionValue) { m_eLastUsedValue_Convert_IMGVersion = eIMGVersionValue; }
	bxa::eIMGVersion							getLastUsedValue_Convert_IMGVersion(void) { return m_eLastUsedValue_Convert_IMGVersion; }
	...
	void								setLastUsedValue_ConvertDFF_RWVersion(bxa::CRWVersion *pRWVersion) { m_pLastUsedValue_ConvertDFF_RWVersion = pRWVersion; }
	bxa::CRWVersion*							getLastUsedValue_ConvertDFF_RWVersion(void) { return m_pLastUsedValue_ConvertDFF_RWVersion; }

	void								setLastUsedValue_ConvertTXD_Game(bxa::ePlatformedGame ePlatformedGameValue) { m_eLastUsedValue_ConvertTXD_Game = ePlatformedGameValue; }
	bxa::ePlatformedGame						getLastUsedValue_ConvertTXD_Game(void) { return m_eLastUsedValue_ConvertTXD_Game; }

	void								setLastUsedValue_ConvertTXD_TextureFormat(bxa::CRasterDataFormat *pRasterDataFormat) { m_pLastUsedValue_ConvertTXD_RasterDataFormat = pRasterDataFormat; }
	bxa::CRasterDataFormat*					getLastUsedValue_ConvertTXD_TextureFormat(void) { return m_pLastUsedValue_ConvertTXD_RasterDataFormat; }

	void								setLastUsedValue_Copy_IMGEntryProperty(bxa::eIMGEntryProperty eIMGEntryPropertyValue) { m_eLastUsedValue_Copy_IMGEntryProperty = eIMGEntryPropertyValue; }
	bxa::eIMGEntryProperty					getLastUsedValue_Copy_IMGEntryProperty(void) { return m_eLastUsedValue_Copy_IMGEntryProperty; }
	...
	void								setLastUsedValue_Select_RWVersion(bxa::CRWVersion *pRWVersion) { m_pLastUsedValue_Select_RWVersion = pRWVersion; }
	bxa::CRWVersion*							getLastUsedValue_Select_RWVersion(void) { return m_pLastUsedValue_Select_RWVersion; }
	...
	void								setLastUsedValue_ConvertTXD_RWVersion(bxa::CRWVersion *pRWVersion) { m_pLastUsedValue_ConvertTXD_RWVersion = pRWVersion; }
	bxa::CRWVersion*							getLastUsedValue_ConvertTXD_RWVersion(void) { return m_pLastUsedValue_ConvertTXD_RWVersion; }
	...
	void								setLastUsedValue_New_IMGVersion(bxa::eIMGVersion eIMGVersionValue) { m_eLastUsedValue_New_IMGVersion = eIMGVersionValue; }
	bxa::eIMGVersion							getLastUsedValue_New_IMGVersion(void) { return m_eLastUsedValue_New_IMGVersion; }

	void								setLastUsedValue_ConvertCOL_COLVersion(bxa::CCOLVersion *pCOLVersion) { m_pLastUsedValue_ConvertCOL_COLVersion = pCOLVersion; }
	bxa::CCOLVersion*						getLastUsedValue_ConvertCOL_COLVersion(void) { return m_pLastUsedValue_ConvertCOL_COLVersion; }
...
private:
	...
	bxa::eIMGVersion							m_eLastUsedValue_Convert_IMGVersion;
	bool								m_bLastUsedValue_ClearLogs_AllTabs;
	bool								m_bLastUsedValue_Close2_CloseAll;
	bxa::CRWVersion*							m_pLastUsedValue_ConvertDFF_RWVersion;
	bxa::ePlatformedGame						m_eLastUsedValue_ConvertTXD_Game;
	bxa::CRasterDataFormat*					m_pLastUsedValue_ConvertTXD_RasterDataFormat;
	bxa::eIMGEntryProperty					m_eLastUsedValue_Copy_IMGEntryProperty;
	bool								m_bLastUsedValue_SaveLog_ActiveTab;
	bool								m_bLastUsedValue_SaveLog_NormalFormat;
	bxa::CRWVersion*							m_pLastUsedValue_Select_RWVersion;
	uint8								m_ucLastUsedValue_Shift_Direction;
	bxa::CRWVersion*							m_pLastUsedValue_ConvertTXD_RWVersion;
	uint8								m_ucLastUsedValue_NameCase_CaseType;
	uint8								m_ucLastUsedValue_NameCase_FilenameType;
	bxa::eIMGVersion							m_eLastUsedValue_New_IMGVersion;
	bxa::CCOLVersion*						m_pLastUsedValue_ConvertCOL_COLVersion;
