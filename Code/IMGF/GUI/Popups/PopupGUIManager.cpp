...
void									PopupGUIManager::updateGUIControlsTextToLanguage(CDialog *pDialog, string strWindowName)
{
	/*
	todo
	auto umapTranslatedTextEntries = CLocalizationManager::get()->getTranslatedTextEntries();
	...
	)
{
	...
	((TextInputDialogData*)GetWindowLong(hwndDlg, GWL_USERDATA))->m_strResultText = CString2::convertCStringToStdString(strText);
	EndDialog(hwndDlg, 0);
	break;
	}
	break;
	...
	)
{
	...
	((Button*)pDialog->GetDlgItem(5))->SetWindowTextW(CString2::convertStdStringToStdWString(pConvertDialogData->m_strButtonText).c_str());
	break;
	case WM_COMMAND:
	switch (wParam)
	{
	...
	)
{
	...
	{
	((CComboBox*)pDialog->GetDlgItem(i))->InsertString(i2, CLocalizationManager::get()->getTranslatedFormattedTextW("Sort_ByText", pSortType->getText().c_str()).c_str());
	...
	)
{
	...
	((CListCtrl*)pDialog->GetDlgItem(1))->InsertColumn(0, CLocalizationManager::get()->getTranslatedTextW("Window_Stats_StatName").c_str(), 0, 150);
	((CListCtrl*)pDialog->GetDlgItem(1))->InsertColumn(1, CLocalizationManager::get()->getTranslatedTextW("Window_Stats_StatValue").c_str(), 1, 150);
	...
	break;
	case 5:
	strSaveFilePath = CInput::saveFileDialog(getIMGF()->getLastUsedDirectory("SAVE_STATS"), "TXT", CLocalizationManager::get()->getTranslatedText("SaveFilePopup_1_InitialFilename"));
	if (strSaveFilePath != "")
	{
	...
	CFile::storeFile(strSaveFilePath, strSaveData, false, false);
	}
	break;
	}
	break;
...
INT_PTR CALLBACK DialogProc_OrphanEntriesDialog(
	...
	((CListCtrl*)pDialog->GetDlgItem(100))->InsertColumn(0, CLocalizationManager::get()->getTranslatedTextW("Window_OrphanEntries_EntryName").c_str(), 0, 200);
	...
	)
{
	...
	uint32 uiResult2 = CInput::showMessage(CLocalizationManager::get()->getTranslatedText("TextPopup_61"), CLocalizationManager::get()->getTranslatedText("TextPopupTitle_61"), MB_OKCANCEL);
	if (uiResult2 == IDOK)
	{
	...
	pSettingsData->m_strQuickExportPath = CInput::chooseFolderDialog(hwndDlg, CLocalizationManager::get()->getTranslatedText("ChooseFolderPopup_1"));
	((CEdit*)pDialog->GetDlgItem(104))->SetWindowTextW(CString2::convertStdStringToStdWString(pSettingsData->m_strQuickExportPath).c_str());
	break;
	case 111: // choose (for automatic logging path)
	pSettingsData->m_strAutomaticLoggingPath = CInput::chooseFolderDialog(hwndDlg, CLocalizationManager::get()->getTranslatedText("ChooseFolderPopup_2"));
	((CEdit*)pDialog->GetDlgItem(110))->SetWindowTextW(CString2::convertStdStringToStdWString(pSettingsData->m_strAutomaticLoggingPath).c_str());
	break;
	}
	break;
	...
	)
{
	...
	pDialog->GetDlgItem(142)->SetWindowTextW((L"- " + CLocalizationManager::get()->getTranslatedTextW("Window_Dump_GameFolderPath")).c_str());
	pDialog->GetDlgItem(147)->SetWindowTextW((L"- " + CLocalizationManager::get()->getTranslatedTextW("Window_Dump_GameFolderPath")).c_str());
	...
	((CComboBox*)pDialog->GetDlgItem(141))->InsertString(0, CLocalizationManager::get()->getTranslatedTextW("Game_III").c_str());
	((CComboBox*)pDialog->GetDlgItem(141))->InsertString(1, CLocalizationManager::get()->getTranslatedTextW("Game_VC").c_str());
	((CComboBox*)pDialog->GetDlgItem(141))->InsertString(2, CLocalizationManager::get()->getTranslatedTextW("Game_SA").c_str());
	((CComboBox*)pDialog->GetDlgItem(141))->InsertString(3, CLocalizationManager::get()->getTranslatedTextW("Game_SOL").c_str());
	((CComboBox*)pDialog->GetDlgItem(141))->InsertString(4, CLocalizationManager::get()->getTranslatedTextW("Other").c_str());
	((CComboBox*)pDialog->GetDlgItem(141))->SetCurSel(0);

	((CComboBox*)pDialog->GetDlgItem(145))->InsertString(0, CLocalizationManager::get()->getTranslatedTextW("Game_III").c_str());
	((CComboBox*)pDialog->GetDlgItem(145))->InsertString(1, CLocalizationManager::get()->getTranslatedTextW("Game_VC").c_str());
	((CComboBox*)pDialog->GetDlgItem(145))->InsertString(2, CLocalizationManager::get()->getTranslatedTextW("Game_SA").c_str());
	((CComboBox*)pDialog->GetDlgItem(145))->InsertString(3, CLocalizationManager::get()->getTranslatedTextW("Game_SOL").c_str());
	...
	*/
	...
	case WM_COMMAND:
		...
		case 112: // dump
			...
			{
				CInput::showMessage(CLocalizationManager::get()->getTranslatedText("TextPopup_2"), CLocalizationManager::get()->getTranslatedFormattedText("TextPopupTitle_PathNotSet").c_str());
				break;
			}
			...
			if (pDumpDialogData->m_uiDumpType == 2) // DAT file
			{
				...
				{
					CInput::showMessage(CLocalizationManager::get()->getTranslatedText("TextPopup_3"), CLocalizationManager::get()->getTranslatedFormattedText("TextPopupTitle_PathNotSet").c_str());
					break;
				}
				if (pDumpDialogData->m_strGameDirectoryPath == "")
				{
					CInput::showMessage(CLocalizationManager::get()->getTranslatedText("TextPopup_4"), CLocalizationManager::get()->getTranslatedFormattedText("TextPopupTitle_PathNotSet").c_str());
					break;
				}
			}
			...
			if (pDumpDialogData->m_uiDumpType == 3) // Game IMGs
			{
				...
				if (pDumpDialogData->m_strGameDirectoryPath == "")
				{
					CInput::showMessage(CLocalizationManager::get()->getTranslatedText("TextPopup_5"), CLocalizationManager::get()->getTranslatedFormattedText("TextPopupTitle_PathNotSet").c_str());
					break;
				}
			}
			...
			{
				pDumpDialogData->m_vecDumpExtensions.push_back(CLocalizationManager::get()->getTranslatedText("Window_Dump_104"));
			}
		...
		case 115: // Change button for DAT file path
			vecFilePaths = CInput::openFile(pDumpDialogData->m_strLastUsedPath__DAT, "DAT", false);
		...
		case 148:
			pDumpDialogData->m_strGameDirectoryPath = CInput::chooseFolderDialog(hwndDlg, CLocalizationManager::get()->getTranslatedText("ChooseFolderPopup_3"), getIMGF()->getLastUsedDirectory("DUMP__GAME"));
			if (pDumpDialogData->m_strGameDirectoryPath == "")
			{
				break;
			}
			pDumpDialogData->m_strGameDirectoryPath = CPath::addSlashToEnd(pDumpDialogData->m_strGameDirectoryPath);
		...
		case 110: // Change button for dump destination folder path
			pDumpDialogData->m_strDumpDestinationFolderPath = CInput::chooseFolderDialog(hwndDlg, CLocalizationManager::get()->getTranslatedText("ChooseFolderPopup_4"), pDumpDialogData->m_strLastUsedPath__Destination);
			if (pDumpDialogData->m_strDumpDestinationFolderPath == "")
			{
				break;
			}
	...
	)
{
	...
	break;
	case 102:
	strSaveFilePath = CInput::saveFileDialog(getIMGF()->getLastUsedDirectory("LISTVIEW__" + pListViewDialogData->m_strSaveFolderPartialHandle), "TXT", pListViewDialogData->m_strSaveFileName);
	if (strSaveFilePath != "")
	{
	...
	)
{
	...
	break;
	case 102:
	strSaveFilePath = CInput::saveFileDialog(getIMGF()->getLastUsedDirectory("TEXTURE_LIST"), "TXT", CLocalizationManager::get()->getTranslatedText("SaveFilePopup_2_InitialFilename"));
	if (strSaveFilePath != "")
	{
	...
	)
{
	...
	((CListCtrl*)pDialog->GetDlgItem(100))->InsertColumn(0, CLocalizationManager::get()->getTranslatedTextW("Window_SessionManager_Column_1").c_str(), 0, 80);
	((CListCtrl*)pDialog->GetDlgItem(100))->InsertColumn(1, CLocalizationManager::get()->getTranslatedTextW("SessionName").c_str(), 0, 150);
	((CListCtrl*)pDialog->GetDlgItem(100))->InsertColumn(2, CLocalizationManager::get()->getTranslatedTextW("Window_SessionManager_Column_3").c_str(), 0, 80);
	((CListCtrl*)pDialog->GetDlgItem(100))->InsertColumn(3, CLocalizationManager::get()->getTranslatedTextW("Window_SessionManager_Column_4").c_str(), 0, 275);
	((CListCtrl*)pDialog->GetDlgItem(100))->SendMessage(LVM_SETEXTENDEDLISTVIEWSTYLE, 0, LVS_EX_FULLROWSELECT);
	...
	{
	vecIMGNames.push_back(CPath::getFileName(deqIMGPaths[i2]));
	}
	...
	case 101:
	// add session
	strNewSessionData = getIMGF()->getPopupGUIManager()->showTextAreaDialog(CLocalizationManager::get()->getTranslatedText("AddSession"), CLocalizationManager::get()->getTranslatedText("Window_TextArea_1_Message"));
	...
	strNewSessionData = getIMGF()->getPopupGUIManager()->showTextAreaDialog(CLocalizationManager::get()->getTranslatedText("UpdateSession"), CLocalizationManager::get()->getTranslatedText("Window_TextArea_1_Message"), CString2::join(CString2::split(strSessionData, "; "), "\n"));
	if (CString2::split(strNewSessionData, "\n").size() >= 2)
	{
	...
	)
{
	...
	// - RW versions
	i = 0;
	((CComboBox*)pDialog->GetDlgItem(52))->AddString(CLocalizationManager::get()->getTranslatedTextW("RWVersion").c_str());
	i++;
	...
	// - COL versions
	i = 0;
	((CComboBox*)pDialog->GetDlgItem(56))->AddString(CLocalizationManager::get()->getTranslatedTextW("COLVersion").c_str());
	i++;
	...
	// - games
	((CComboBox*)pDialog->GetDlgItem(54))->AddString(CLocalizationManager::get()->getTranslatedTextW("Menu_Convert_TXD_Game").c_str());
	/*
	for (auto pGame : CGeneralManager::get()->getGameManager()->getEntries())
	{
	((CComboBox*)pDialog->GetDlgItem(54))->AddString(CLocalizationManager::get()->getTranslatedTextW(pGame->getLocalizationKey()).c_str());
	}
	*/

	/*
	todo
	((CComboBox*) pDialog->GetDlgItem(54))->AddString(CLocalizationManager::get()->getTranslatedTextW("Game_III").c_str());
	((CComboBox*) pDialog->GetDlgItem(54))->AddString(CLocalizationManager::get()->getTranslatedTextW("Game_VC").c_str());
	((CComboBox*) pDialog->GetDlgItem(54))->AddString(CLocalizationManager::get()->getTranslatedTextW("Game_SA").c_str());
	((CComboBox*) pDialog->GetDlgItem(54))->AddString(CLocalizationManager::get()->getTranslatedTextW("GTA_Android").c_str());
	((CComboBox*) pDialog->GetDlgItem(54))->AddString(CLocalizationManager::get()->getTranslatedTextW("GTA_XBOX").c_str());
	...
	// - texture formats
	((CComboBox*) pDialog->GetDlgItem(54))->AddString(CLocalizationManager::get()->getTranslatedTextW("Menu_Convert_TXD_TextureFormat").c_str());
	for (auto pRasterDataFormat : CImageManager::get()->getRasterDataFormatManager()->getEntries())
	{
		((CComboBox*) pDialog->GetDlgItem(54))->AddString(CLocalizationManager::get()->getTranslatedTextW(pRasterDataFormat->getLocalizationKey()).c_str());
	...
	)
{
	...
	pDialog->GetDlgItem(2)->SetWindowTextW(CLocalizationManager::get()->getTranslatedTextW("Window_Credits_ProjectLeader").c_str());
	pDialog->GetDlgItem(4)->SetWindowTextW(CLocalizationManager::get()->getTranslatedTextW("Window_Credits_ProjectLeader").c_str());

	pDialog->GetDlgItem(5)->SetWindowTextW(CLocalizationManager::get()->getTranslatedTextW("Window_Credits_Programmer").c_str());

	pDialog->GetDlgItem(7)->SetWindowTextW(CLocalizationManager::get()->getTranslatedTextW("Window_Credits_Tester").c_str());
	pDialog->GetDlgItem(9)->SetWindowTextW(CLocalizationManager::get()->getTranslatedTextW("Window_Credits_Tester").c_str());
	...
	)
{
	...
	pDialog->GetDlgItem(157)->SetWindowTextW(CLocalizationManager::get()->getTranslatedTextW("Window_Renamer_ChooseFolder").c_str());
	pDialog->GetDlgItem(158)->SetWindowTextW(CLocalizationManager::get()->getTranslatedTextW("Window_Renamer_ChooseFolder").c_str());
	pDialog->GetDlgItem(159)->SetWindowTextW(CLocalizationManager::get()->getTranslatedTextW("Window_Renamer_ChooseFolder").c_str());

	pDialog->GetDlgItem(201)->SetWindowTextW(CLocalizationManager::get()->getTranslatedTextW("Window_Renamer_Front").c_str());
	pDialog->GetDlgItem(301)->SetWindowTextW(CLocalizationManager::get()->getTranslatedTextW("Window_Renamer_Front").c_str());

	pDialog->GetDlgItem(202)->SetWindowTextW(CLocalizationManager::get()->getTranslatedTextW("Window_Renamer_End").c_str());
	pDialog->GetDlgItem(302)->SetWindowTextW(CLocalizationManager::get()->getTranslatedTextW("Window_Renamer_End").c_str());

	pDialog->GetDlgItem(203)->SetWindowTextW(CLocalizationManager::get()->getTranslatedTextW("Window_Renamer_AtPosition").c_str());
	pDialog->GetDlgItem(303)->SetWindowTextW(CLocalizationManager::get()->getTranslatedTextW("Window_Renamer_AtPosition").c_str());

	pDialog->GetDlgItem(207)->SetWindowTextW(CLocalizationManager::get()->getTranslatedTextW("Window_Renamer_Position").c_str());
	pDialog->GetDlgItem(307)->SetWindowTextW(CLocalizationManager::get()->getTranslatedTextW("Window_Renamer_Position").c_str());
	...
	{
	CInput::showMessage(CLocalizationManager::get()->getTranslatedText("TextPopup_6"), CLocalizationManager::get()->getTranslatedFormattedText("TextPopupTitle_PathNotSet").c_str());
	break;
	}
	}
	if (((Button*)pDialog->GetDlgItem(152))->GetCheck() == BST_CHECKED)
	...
	{
	CInput::showMessage(CLocalizationManager::get()->getTranslatedText("TextPopup_7"), CLocalizationManager::get()->getTranslatedFormattedText("TextPopupTitle_PathNotSet").c_str());
	break;
	}
	}
	if (((Button*)pDialog->GetDlgItem(153))->GetCheck() == BST_CHECKED)
	...
	{
	CInput::showMessage(CLocalizationManager::get()->getTranslatedText("TextPopup_8"), CLocalizationManager::get()->getTranslatedFormattedText("TextPopupTitle_PathNotSet").c_str());
	break;
	}
	}
	...
	if (strStr4 == "")
	{
	CInput::showMessage(CLocalizationManager::get()->getTranslatedText("TextPopup_9"), CLocalizationManager::get()->getTranslatedFormattedText("TextPopupTitle_InputRequired").c_str());
	break;
	}
	...
	if (strStr5 == "")
	{
	CInput::showMessage(CLocalizationManager::get()->getTranslatedText("TextPopup_10"), CLocalizationManager::get()->getTranslatedFormattedText("TextPopupTitle_InputRequired").c_str());
	break;
	}
	...
	if (strStr9 == "")
	{
	CInput::showMessage(CLocalizationManager::get()->getTranslatedText("TextPopup_11"), CLocalizationManager::get()->getTranslatedFormattedText("TextPopupTitle_InputRequired").c_str());
	break;
	}
	...
	pRenamerDialogData->m_strMatchingPath_IDE = CInput::chooseFolderDialog(hwndDlg, CLocalizationManager::get()->getTranslatedText("ChooseFolderPopup_5"), getIMGF()->getLastUsedDirectory("RENAMER__MATCHING_IDE"));
	if (pRenamerDialogData->m_strMatchingPath_IDE == "")
	{
	break;
	}
	pRenamerDialogData->m_strMatchingPath_IDE = CPath::addSlashToEnd(pRenamerDialogData->m_strMatchingPath_IDE);
	...
	pRenamerDialogData->m_strMatchingPath_IPL = CInput::chooseFolderDialog(hwndDlg, CLocalizationManager::get()->getTranslatedText("ChooseFolderPopup_6"), getIMGF()->getLastUsedDirectory("RENAMER__MATCHING_IPL"));
	if (pRenamerDialogData->m_strMatchingPath_IPL == "")
	{
	break;
	}
	pRenamerDialogData->m_strMatchingPath_IPL = CPath::addSlashToEnd(pRenamerDialogData->m_strMatchingPath_IPL);
	...
	pRenamerDialogData->m_strMatchingPath_COL = CInput::chooseFolderDialog(hwndDlg, CLocalizationManager::get()->getTranslatedText("ChooseFolderPopup_7"), getIMGF()->getLastUsedDirectory("RENAMER__MATCHING_COL"));
	if (pRenamerDialogData->m_strMatchingPath_COL == "")
	{
	break;
	}
	pRenamerDialogData->m_strMatchingPath_COL = CPath::addSlashToEnd(pRenamerDialogData->m_strMatchingPath_COL);
	...
	)
{
	...
	{
	CInput::showMessage(CLocalizationManager::get()->getTranslatedText("TextPopup_12"), CLocalizationManager::get()->getTranslatedFormattedText("TextPopupTitle_InputRequired").c_str());
	break;
	}
	}
	...
	if (strStr1 == "" || strStr2 == "" || strStr3 == "" || strStr4 == "")
	{
	CInput::showMessage(CLocalizationManager::get()->getTranslatedText("TextPopup_13"), CLocalizationManager::get()->getTranslatedFormattedText("TextPopupTitle_InputRequired").c_str());
	break;
	}
	}
	...
	)
{
	...
	pDialog->GetDlgItem(204)->SetWindowTextW((L"- " + CLocalizationManager::get()->getTranslatedTextW("Window_Dump_GameFolderPath")).c_str());

	((Button*)pDialog->GetDlgItem(150))->SetCheck(BST_CHECKED);

	((CComboBox*)pDialog->GetDlgItem(201))->InsertString(0, CLocalizationManager::get()->getTranslatedTextW("Game_III").c_str());
	((CComboBox*)pDialog->GetDlgItem(201))->InsertString(1, CLocalizationManager::get()->getTranslatedTextW("Game_VC").c_str());
	((CComboBox*)pDialog->GetDlgItem(201))->InsertString(2, CLocalizationManager::get()->getTranslatedTextW("Game_SA").c_str());
	((CComboBox*)pDialog->GetDlgItem(201))->InsertString(3, CLocalizationManager::get()->getTranslatedTextW("Game_SOL").c_str());
	((CComboBox*)pDialog->GetDlgItem(201))->InsertString(4, CLocalizationManager::get()->getTranslatedTextW("Other").c_str());
	...
	{
	CInput::showMessage(CLocalizationManager::get()->getTranslatedText("TextPopup_14"), CLocalizationManager::get()->getTranslatedFormattedText("TextPopupTitle_PathNotSet").c_str());
	break;
	}
	if (pDuplicateEntriesDialogData->m_strDATGameDirectoryPath == "")
	{
	CInput::showMessage(CLocalizationManager::get()->getTranslatedText("TextPopup_15"), CLocalizationManager::get()->getTranslatedFormattedText("TextPopupTitle_PathNotSet").c_str());
	break;
	}
	}
	...
	vecFilePaths = CInput::openFile(getIMGF()->getLastUsedDirectory("DUPLICATEENTRIES__DAT"), "DAT", false);
	if (vecFilePaths.size() == 0)
	{
	break;
	}
	...
	pDuplicateEntriesDialogData->m_strDATGameDirectoryPath = CInput::chooseFolderDialog(hwndDlg, CLocalizationManager::get()->getTranslatedText("ChooseFolderPopup_3"), getIMGF()->getLastUsedDirectory("DUPLICATEENTRIES__GAME"));
	if (pDuplicateEntriesDialogData->m_strDATGameDirectoryPath == "")
	{
	break;
	}
	pDuplicateEntriesDialogData->m_strDATGameDirectoryPath = CPath::addSlashToEnd(pDuplicateEntriesDialogData->m_strDATGameDirectoryPath);
	...
	)
{
	...
	((CComboBox*)pDialog->GetDlgItem(201))->SetWindowText(CLocalizationManager::get()->getTranslatedTextW("Digit0").c_str());
	...
	pBuildTXDDialogData->m_strTexturesFolderPath = CPath::addSlashToEnd(CString2::convertCStringToStdString(cstr1));
	pBuildTXDDialogData->m_strDestinationFolderPath = CPath::addSlashToEnd(CString2::convertCStringToStdString(cstr2));
	...
	pBuildTXDDialogData->m_strDFFsFolderPath = CPath::addSlashToEnd(CString2::convertCStringToStdString(cstr4));
	}
	...
	{
	CInput::showMessage(CLocalizationManager::get()->getTranslatedText("TextPopup_16"), CLocalizationManager::get()->getTranslatedFormattedText("TextPopupTitle_PathNotSet").c_str());
	break;
	}
	}
	...
	{
	CInput::showMessage(CLocalizationManager::get()->getTranslatedText("TextPopup_17"), CLocalizationManager::get()->getTranslatedFormattedText("TextPopupTitle_PathNotSet").c_str());
	break;
	}

	if (pBuildTXDDialogData->m_strDFFsFolderPath == "")
	{
	CInput::showMessage(CLocalizationManager::get()->getTranslatedText("TextPopup_18"), CLocalizationManager::get()->getTranslatedFormattedText("TextPopupTitle_PathNotSet").c_str());
	break;
	}
	}
	...
	{
	CInput::showMessage(CLocalizationManager::get()->getTranslatedText("TextPopup_19"), CLocalizationManager::get()->getTranslatedFormattedText("TextPopupTitle_PathNotSet").c_str());
	break;
	}

	if (pBuildTXDDialogData->m_strDestinationFolderPath == "")
	{
	CInput::showMessage(CLocalizationManager::get()->getTranslatedText("TextPopup_20"), CLocalizationManager::get()->getTranslatedFormattedText("TextPopupTitle_PathNotSet").c_str());
	break;
	}
	...
	case 114:
	pBuildTXDDialogData->m_strDFFsFolderPath = CInput::chooseFolderDialog(hwndDlg, CLocalizationManager::get()->getTranslatedText("ChooseFolderPopup_8"), getIMGF()->getLastUsedDirectory("BUILDTXD__DFF"));
	if (pBuildTXDDialogData->m_strDFFsFolderPath == "")
	{
	break;
	}
	pBuildTXDDialogData->m_strDFFsFolderPath = CPath::addSlashToEnd(pBuildTXDDialogData->m_strDFFsFolderPath);
	...
	vecFilePaths = CInput::openFile(getIMGF()->getLastUsedDirectory("BUILDTXD__IDE"), "IDE", false);
	if (vecFilePaths.size() == 0)
	{
	break;
	}
	...
	pBuildTXDDialogData->m_strTexturesFolderPath = CInput::chooseFolderDialog(hwndDlg, CLocalizationManager::get()->getTranslatedText("ChooseFolderPopup_9"), getIMGF()->getLastUsedDirectory("BUILDTXD__TEXTURES"));
	if (pBuildTXDDialogData->m_strTexturesFolderPath == "")
	{
	break;
	}
	...
	pBuildTXDDialogData->m_strDestinationFolderPath = CInput::chooseFolderDialog(hwndDlg, CLocalizationManager::get()->getTranslatedText("ChooseFolderPopup_10"), getIMGF()->getLastUsedDirectory("BUILDTXD__DESTINATION"));
	if (pBuildTXDDialogData->m_strDestinationFolderPath == "")
	{
	break;
	}
	...
	)
{
	...
	((CComboBox*)pDialog->GetDlgItem(155))->InsertString(0, CLocalizationManager::get()->getTranslatedTextW("CompressionType_None").c_str());
	((CComboBox*)pDialog->GetDlgItem(155))->InsertString(1, CLocalizationManager::get()->getTranslatedTextW("CompressionType_ZLib").c_str());
	((CComboBox*)pDialog->GetDlgItem(155))->InsertString(2, CLocalizationManager::get()->getTranslatedTextW("CompressionType_LZ4").c_str());
	...
	)
{
	...
	for (auto pRasterDataFormat : CImageManager::get()->getRasterDataFormatManager()->getEntries())
	{
	((CComboBox*)pDialog->GetDlgItem(114))->InsertString(i, CLocalizationManager::get()->getTranslatedTextW(pRasterDataFormat->getLocalizationKey()).c_str());
	i++;
	}
	...
	if (strString1 == "")
	{
	CInput::showMessage(CLocalizationManager::get()->getTranslatedText("TextPopup_24"), CLocalizationManager::get()->getTranslatedFormattedText("TextPopupTitle_InputRequired").c_str());
	break;
	}

	if (pTXDOrganizerDialogData->m_strTXDNamePrefix == "")
	{
	CInput::showMessage(CLocalizationManager::get()->getTranslatedText("TextPopup_25"), CLocalizationManager::get()->getTranslatedFormattedText("TextPopupTitle_InputRequired").c_str());
	break;
	}

	if (pTXDOrganizerDialogData->m_strTextureImportFolderPath == "")
	{
	CInput::showMessage(CLocalizationManager::get()->getTranslatedText("TextPopup_26"), CLocalizationManager::get()->getTranslatedFormattedText("TextPopupTitle_PathNotSet").c_str());
	break;
	}

	if (pTXDOrganizerDialogData->m_strOutputFolderPath == "")
	{
	CInput::showMessage(CLocalizationManager::get()->getTranslatedText("TextPopup_28"), CLocalizationManager::get()->getTranslatedFormattedText("TextPopupTitle_PathNotSet").c_str());
	break;
	}
	...
	{
	CInput::showMessage(CLocalizationManager::get()->getTranslatedText("TextPopup_30"), CLocalizationManager::get()->getTranslatedFormattedText("TextPopupTitle_PathNotSet").c_str());
	break;
	}
	}

	pTXDOrganizerDialogData->m_pRasterDataFormat = CImageManager::get()->getRasterDataFormatManager()->getEntryByIndex(((CComboBox*)pDialog->GetDlgItem(114))->GetCurSel());

	pTXDOrganizerDialogData->m_strTextureImportFolderPath = CPath::addSlashToEnd(pTXDOrganizerDialogData->m_strTextureImportFolderPath);
	pTXDOrganizerDialogData->m_strIDEUpdateFolderPath = CPath::addSlashToEnd(pTXDOrganizerDialogData->m_strIDEUpdateFolderPath);
	pTXDOrganizerDialogData->m_strOutputFolderPath = CPath::addSlashToEnd(pTXDOrganizerDialogData->m_strOutputFolderPath);

	EndDialog(hwndDlg, 0);
	break;
	}
	case 106: // Change button for Texture Import Folder Path
	pTXDOrganizerDialogData->m_strTextureImportFolderPath = CInput::chooseFolderDialog(hwndDlg, CLocalizationManager::get()->getTranslatedText("ChooseFolderPopup_18"), getIMGF()->getLastUsedDirectory("TXDORGANIZER_TEXTUREIMPORT"));
	if (pTXDOrganizerDialogData->m_strTextureImportFolderPath == "")
	{
	break;
	}
	...
	pTXDOrganizerDialogData->m_strIDEUpdateFolderPath = CInput::chooseFolderDialog(hwndDlg, CLocalizationManager::get()->getTranslatedText("ChooseFolderPopup_19"), getIMGF()->getLastUsedDirectory("TXDORGANIZER_IDEUPDATE"));
	if (pTXDOrganizerDialogData->m_strIDEUpdateFolderPath == "")
	{
	break;
	}
	...
	pTXDOrganizerDialogData->m_strOutputFolderPath = CInput::chooseFolderDialog(hwndDlg, CLocalizationManager::get()->getTranslatedText("ChooseFolderPopup_20"), getIMGF()->getLastUsedDirectory("TXDORGANIZER_OUTPUTFOLDER"));
	if (pTXDOrganizerDialogData->m_strOutputFolderPath == "")
	{
	break;
	}
	...
	)
{
	...
	if (str1 == "")
	{
	CInput::showMessage(CLocalizationManager::get()->getTranslatedFormattedText("TextPopup_31", "min", "x"), CLocalizationManager::get()->getTranslatedFormattedText("TextPopupTitle_InputRequired").c_str());
	break;
	}
	if (str2 == "")
	{
	CInput::showMessage(CLocalizationManager::get()->getTranslatedFormattedText("TextPopup_31", "min", "y"), CLocalizationManager::get()->getTranslatedFormattedText("TextPopupTitle_InputRequired").c_str());
	break;
	}
	if (str3 == "")
	{
	CInput::showMessage(CLocalizationManager::get()->getTranslatedFormattedText("TextPopup_31", "max", "x"), CLocalizationManager::get()->getTranslatedFormattedText("TextPopupTitle_InputRequired").c_str());
	break;
	}
	if (str4 == "")
	{
	CInput::showMessage(CLocalizationManager::get()->getTranslatedFormattedText("TextPopup_31", "max", "y"), CLocalizationManager::get()->getTranslatedFormattedText("TextPopupTitle_InputRequired").c_str());
	break;
	}

	if (str5 == "")
	{
	CInput::showMessage(CLocalizationManager::get()->getTranslatedFormattedText("TextPopup_35", "width"), CLocalizationManager::get()->getTranslatedFormattedText("TextPopupTitle_InputRequired").c_str());
	break;
	}
	if (str6 == "")
	{
	CInput::showMessage(CLocalizationManager::get()->getTranslatedFormattedText("TextPopup_35", "height"), CLocalizationManager::get()->getTranslatedFormattedText("TextPopupTitle_InputRequired").c_str());
	break;
	}

	if (str7 == "")
	{
	CInput::showMessage(CLocalizationManager::get()->getTranslatedFormattedText("TextPopup_57", "x"), CLocalizationManager::get()->getTranslatedFormattedText("TextPopupTitle_InputRequired").c_str());
	break;
	}
	if (str8 == "")
	{
	CInput::showMessage(CLocalizationManager::get()->getTranslatedFormattedText("TextPopup_57", "y"), CLocalizationManager::get()->getTranslatedFormattedText("TextPopupTitle_InputRequired").c_str());
	break;
	}
	if (str9 == "")
	{
	CInput::showMessage(CLocalizationManager::get()->getTranslatedFormattedText("TextPopup_57", "z"), CLocalizationManager::get()->getTranslatedFormattedText("TextPopupTitle_InputRequired").c_str());
	break;
	}

	if (pDATPathsMoverDialogData->m_strInputFolderPath == "")
	{
	CInput::showMessage(CLocalizationManager::get()->getTranslatedText("TextPopup_58"), CLocalizationManager::get()->getTranslatedFormattedText("TextPopupTitle_PathNotSet").c_str());
	break;
	}

	if (pDATPathsMoverDialogData->m_strOutputFolderPath == "")
	{
	CInput::showMessage(CLocalizationManager::get()->getTranslatedText("TextPopup_59"), CLocalizationManager::get()->getTranslatedFormattedText("TextPopupTitle_PathNotSet").c_str());
	break;
	}

	pDATPathsMoverDialogData->m_vecOutputMapRangeMin.x = CString2::toFloat32(CString2::convertCStringToStdString(cstr1));
	pDATPathsMoverDialogData->m_vecOutputMapRangeMin.y = CString2::toFloat32(CString2::convertCStringToStdString(cstr2));
	pDATPathsMoverDialogData->m_vecOutputMapRangeMax.x = CString2::toFloat32(CString2::convertCStringToStdString(cstr3));
	pDATPathsMoverDialogData->m_vecOutputMapRangeMax.y = CString2::toFloat32(CString2::convertCStringToStdString(cstr4));

	pDATPathsMoverDialogData->m_vecOutputTileSize.x = CString2::toFloat32(CString2::convertCStringToStdString(cstr5));
	pDATPathsMoverDialogData->m_vecOutputTileSize.y = CString2::toFloat32(CString2::convertCStringToStdString(cstr6));

	pDATPathsMoverDialogData->m_vecPositionOffset.x = CString2::toFloat32(CString2::convertCStringToStdString(cstr7));
	pDATPathsMoverDialogData->m_vecPositionOffset.y = CString2::toFloat32(CString2::convertCStringToStdString(cstr8));
	pDATPathsMoverDialogData->m_vecPositionOffset.z = CString2::toFloat32(CString2::convertCStringToStdString(cstr9));

	pDATPathsMoverDialogData->m_strInputFolderPath = CPath::addSlashToEnd(pDATPathsMoverDialogData->m_strInputFolderPath);
	pDATPathsMoverDialogData->m_strOutputFolderPath = CPath::addSlashToEnd(pDATPathsMoverDialogData->m_strOutputFolderPath);

	EndDialog(hwndDlg, 0);
	break;
	}
	case 252: // Change button for Input Folder
	pDATPathsMoverDialogData->m_strInputFolderPath = CInput::chooseFolderDialog(hwndDlg, CLocalizationManager::get()->getTranslatedText("ChooseFolderPopup_21"), getIMGF()->getLastUsedDirectory("DATPATHSMOVER_DATINPUT"));
	if (pDATPathsMoverDialogData->m_strInputFolderPath == "")
	{
	break;
	}
	...
	pDATPathsMoverDialogData->m_strOutputFolderPath = CInput::chooseFolderDialog(hwndDlg, CLocalizationManager::get()->getTranslatedText("ChooseFolderPopup_22"), getIMGF()->getLastUsedDirectory("DATPATHSMOVER_DATOUTPUT"));
	if (pDATPathsMoverDialogData->m_strOutputFolderPath == "")
	{
	break;
	}
	...
	)
{
	...
	if (str1 == "")
	{
	CInput::showMessage(CLocalizationManager::get()->getTranslatedText("TextPopup_62"), CLocalizationManager::get()->getTranslatedFormattedText("TextPopupTitle_InputRequired").c_str());
	break;
	}
	if (str2 == "")
	{
	CInput::showMessage(CLocalizationManager::get()->getTranslatedText("ChooseFolderPopup_3"), CLocalizationManager::get()->getTranslatedFormattedText("TextPopupTitle_InputRequired").c_str());
	break;
	}
	...
	if (str3 == "")
	{
	CInput::showMessage(CLocalizationManager::get()->getTranslatedText("TextPopup_64"), CLocalizationManager::get()->getTranslatedFormattedText("TextPopupTitle_InputRequired").c_str());
	break;
	}
	}
	...
	if (str4 == "")
	{
	CInput::showMessage(CLocalizationManager::get()->getTranslatedText("TextPopup_65"), CLocalizationManager::get()->getTranslatedFormattedText("TextPopupTitle_InputRequired").c_str());
	break;
	}
	}
	if (str5 == "")
	{
	CInput::showMessage(CLocalizationManager::get()->getTranslatedText("TextPopup_28"), CLocalizationManager::get()->getTranslatedFormattedText("TextPopupTitle_InputRequired").c_str());
	break;
	}

	pMapMoverAndIDShifterDialogData->m_strGameFolderPath = CPath::addSlashToEnd(pMapMoverAndIDShifterDialogData->m_strGameFolderPath);
	pMapMoverAndIDShifterDialogData->m_strUpdateIDEInFolderPath = CPath::addSlashToEnd(pMapMoverAndIDShifterDialogData->m_strUpdateIDEInFolderPath);
	pMapMoverAndIDShifterDialogData->m_strUpdateIPLInFolderPath = CPath::addSlashToEnd(pMapMoverAndIDShifterDialogData->m_strUpdateIPLInFolderPath);
	...
	pMapMoverAndIDShifterDialogData->m_vecPositionOffset.x = CString2::toFloat32(str7);
	pMapMoverAndIDShifterDialogData->m_vecPositionOffset.y = CString2::toFloat32(str8);
	pMapMoverAndIDShifterDialogData->m_vecPositionOffset.z = CString2::toFloat32(str9);

	if (pMapMoverAndIDShifterDialogData->m_bMovePosition)
	{
	if (str6 == "")
	{
	CInput::showMessage(CLocalizationManager::get()->getTranslatedText("TextPopup_66"), CLocalizationManager::get()->getTranslatedFormattedText("TextPopupTitle_InputRequired").c_str());
	break;
	}
	}
	...
	if (str7 == "")
	{
	CInput::showMessage(CLocalizationManager::get()->getTranslatedFormattedText("TextPopup_67", "X"), CLocalizationManager::get()->getTranslatedFormattedText("TextPopupTitle_InputRequired").c_str());
	break;
	}
	if (str8 == "")
	{
	CInput::showMessage(CLocalizationManager::get()->getTranslatedFormattedText("TextPopup_67", "Y"), CLocalizationManager::get()->getTranslatedFormattedText("TextPopupTitle_InputRequired").c_str());
	break;
	}
	if (str9 == "")
	{
	CInput::showMessage(CLocalizationManager::get()->getTranslatedFormattedText("TextPopup_67", "Z"), CLocalizationManager::get()->getTranslatedFormattedText("TextPopupTitle_InputRequired").c_str());
	break;
	}
	}
	else
	{
	CInput::showMessage("You must choose an action (ID Shifter or Map Mover)", "Action Choice Required");
	break;
	}
	...
	{
	vector<string> vecFilePaths = CInput::openFile(getIMGF()->getLastUsedDirectory("MAPMOVERANDIDSHIFTER_DATINPUT"), "DAT", false);
	if (vecFilePaths.size() == 0)
	{
	break;
	}
	pMapMoverAndIDShifterDialogData->m_strDATFilePath = vecFilePaths[0];
	getIMGF()->setLastUsedDirectory("MAPMOVERANDIDSHIFTER_DATINPUT", CPath::getDirectory(pMapMoverAndIDShifterDialogData->m_strDATFilePath));
	...
	pMapMoverAndIDShifterDialogData->m_strGameFolderPath = CInput::chooseFolderDialog(hwndDlg, CLocalizationManager::get()->getTranslatedText("ChooseFolderPopup_3"), getIMGF()->getLastUsedDirectory("MAPMOVERANDIDSHIFTER_GAMEFOLDER"));
	...
	pMapMoverAndIDShifterDialogData->m_strUpdateIDEInFolderPath = CInput::chooseFolderDialog(hwndDlg, CLocalizationManager::get()->getTranslatedText("ChooseFolderPopup_5"), getIMGF()->getLastUsedDirectory("MAPMOVERANDIDSHIFTER_IDEFOLDER"));
	...
	pMapMoverAndIDShifterDialogData->m_strUpdateIPLInFolderPath = CInput::chooseFolderDialog(hwndDlg, CLocalizationManager::get()->getTranslatedText("ChooseFolderPopup_6"), getIMGF()->getLastUsedDirectory("MAPMOVERANDIDSHIFTER_IPLFOLDER"));
	...
	pMapMoverAndIDShifterDialogData->m_strOutputFolderPath = CInput::chooseFolderDialog(CLocalizationManager::get()->getTranslatedText("TextPopup_28"), getIMGF()->getLastUsedDirectory("MAPMOVERANDIDSHIFTER_OUTPUTFOLDER"));
	if (pMapMoverAndIDShifterDialogData->m_strOutputFolderPath == "")
	{
	break;
	}
	pMapMoverAndIDShifterDialogData->m_strOutputFolderPath = CPath::addSlashToEnd(pMapMoverAndIDShifterDialogData->m_strOutputFolderPath);
	getIMGF()->setLastUsedDirectory("MAPMOVERANDIDSHIFTER_OUTPUTFOLDER", CPath::getDirectory(pMapMoverAndIDShifterDialogData->m_strOutputFolderPath));
	...
	)
{
	...
	if (str3 == "")
	{
	CInput::showMessage(CLocalizationManager::get()->getTranslatedText("TextPopup_63"), CLocalizationManager::get()->getTranslatedFormattedText("TextPopupTitle_InputRequired").c_str());
	break;
	}

	pDATModelListDialogData->m_strGameFolderPath = CPath::addSlashToEnd(pDATModelListDialogData->m_strGameFolderPath);
	...
	case 102: // Change button for DAT File
	{
	vector<string> vecFilePaths = CInput::openFile(getIMGF()->getLastUsedDirectory("DATMODELLIST_DATINPUT"), "DAT", false);
	if (vecFilePaths.size() == 0)
	{
	break;
	}
	pDATModelListDialogData->m_strDATFilePath = vecFilePaths[0];
	getIMGF()->setLastUsedDirectory("DATMODELLIST_DATINPUT", CPath::getDirectory(pDATModelListDialogData->m_strDATFilePath));
	...
	case 105: // Change button for Game Folder
	pDATModelListDialogData->m_strGameFolderPath = CInput::chooseFolderDialog(hwndDlg, CLocalizationManager::get()->getTranslatedText("ChooseFolderPopup_3"), getIMGF()->getLastUsedDirectory("DATMODELLIST_GAMEFOLDER"));
	...
	pDATModelListDialogData->m_strOutputFilePath = CInput::saveFileDialog(getIMGF()->getLastUsedDirectory("DATMODELLIST_TXTOUTPUT"), "TXT", "Model List.txt");
	if (pDATModelListDialogData->m_strOutputFilePath == "")
	{
	break;
	}
	getIMGF()->setLastUsedDirectory("DATMODELLIST_TXTOUTPUT", CPath::getDirectory(pDATModelListDialogData->m_strOutputFilePath));
