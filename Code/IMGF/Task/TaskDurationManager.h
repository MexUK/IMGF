...
public:
	...
	std::vector<uint32>&	getTaskBeginTimes(void) { return m_vecTaskBeginTimes; } // in milliseconds, indexes are sync'd with TaskManager::m_vecActiveTaskNames
	std::vector<uint32>&	getTaskPauseDurations(void) { return m_vecTaskPauseDurations; } // in milliseconds, indexes are sync'd with TaskManager::m_vecActiveTaskNames
...
private:
	std::vector<uint32>		m_vecTaskBeginTimes; // in milliseconds, indexes are sync'd with TaskManager::m_vecActiveTaskNames
