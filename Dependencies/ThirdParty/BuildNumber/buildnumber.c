#include <Windows.h>
/*
This file has been modified by Mex to work with build numbers higher than 9999
*/
...
{
	char *pPath = "..\\..\\..\\Dependencies\\ThirdParty\\BuildNumber\\buildnumber.h"; // todo - absolute path
  FILE *file;
  int i = 0;
  char line[80];
  size_t length = 0;
  ...
  {
    fprintf(stderr, "BuildNumber: error creating buildnumber.h\n"); 
    return EXIT_FAILURE;
  }
  ...
  else
  {
    fprintf(file, "/* Generated by BuildNumber Version %d.%d */\n\n", 
      MAJOR_VERSION, MINOR_VERSION);
    fprintf(file, "#ifndef BUILD_NUMBER_H_ \n");
    fprintf(file, "#define BUILD_NUMBER_H_ \n\n");
    fprintf(file, "#define BUILDNUMBER %d\n", build_number);
    fprintf(file, "#define BUILDNUMBER_STR \"%d\" \n\n", build_number);
    fprintf(file, "#endif /* BUILD_NUMBER_H_ */\n");
