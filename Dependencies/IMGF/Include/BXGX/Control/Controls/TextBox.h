...
class bxgx::TextBox : public bxgx::Control
{
public:
	TextBox(void);
	~TextBox(void);
	...
	bool									onKeyDown(uint16 uiCharCode);
	bool									onCharDown(uint16 uiCharCode);
	...
	//void									addTextToLine(uint32 uiLineIndex, std::string& strText, uint32 uiCharIndex);
