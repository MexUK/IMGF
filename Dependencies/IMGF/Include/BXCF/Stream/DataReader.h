...
class bxcf::DataReader : public bxcf::DataStream, public bxcf::IndexedInstance<bxcf::DataReader>
{
public:
	DataReader(void);
	DataReader(std::string& strFilePath);
	...
	void					readLineEntries(bxcf::VectorPool<DerivedFormatClass> *pPool);
	template <typename LineTypeEnum, class SectionClass, class EntryClass>
	void					readSectionLineEntries(bxcf::VectorPool<SectionClass> *pPool);
...
template <class DerivedFormatClass>
void						bxcf::DataReader::readLineEntries(bxcf::VectorPool<DerivedFormatClass> *pPool)
{
...
template <typename LineTypeEnum, class SectionClass, class EntryClass>
void					bxcf::DataReader::readSectionLineEntries(bxcf::VectorPool<SectionClass> *pPool)
{
	DataReader *pDataReader = DataReader::get();
