...
void			bxcf::CMemoryManager::push(unsigned long uiArgument)
{
	__asm
	{
		push	uiArgument
...
void			bxcf::CMemoryManager::pushVL(unsigned short usStackEntryCount, va_list vlArguments)
{
...
void			bxcf::CMemoryManager::removeStackArguments(unsigned short usStackEntryCount)
{
