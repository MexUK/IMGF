...
class bxcf::CRWSection_TextureNative : public bxcf::CRWSection
{
public:
	...
	bxcf::CVectorPool<bxcf::CRWEntry_TextureNative_MipMap*>&	getMipMaps(void) { return m_vecMipMaps; }
...
private:
	...
	bxcf::CVectorPool<bxcf::CRWEntry_TextureNative_MipMap*>	m_vecMipMaps;
};
