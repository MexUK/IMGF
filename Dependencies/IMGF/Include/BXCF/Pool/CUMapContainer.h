...
template <class Key, class Value>
bool				bxcf::CUMapContainer<Key, Value>::doesKeyExist(Key key)
{
	return m_umapEntries.count(key) != 0;
}

template <class Key, class Value>
uint32				bxcf::CUMapContainer<Key, Value>::getEntryCount(void)
{
	return m_umapEntries.size();
}

template <class Key, class Value>
void				bxcf::CUMapContainer<Key, Value>::setEntry(Key key, Value value)
{
	m_umapEntries[key] = value;
}

template <class Key, class Value>
Value				bxcf::CUMapContainer<Key, Value>::getEntry(Key key)
{
	if (doesKeyExist(key))
	{
...
template <class Key, class Value>
Key					bxcf::CUMapContainer<Key, Value>::getKeyByValue(Value value)
{
...
template <class Key, class Value>
void				bxcf::CUMapContainer<Key, Value>::removeEntry(Key key)
{
...
template <class Key, class Value>
void				bxcf::CUMapContainer<Key, Value>::removeAllEntries(void)
{
	m_umapEntries.clear();
}

template <class Key, class Value>
void				bxcf::CUMapContainer<Key, Value>::swapEntries(Key key1, Key key2)
{
