...
class bxgi::CDATChaseFormat;

class bxgi::CDATChaseEntry
{
public:
	CDATChaseEntry(void);
	...
	void					setFormat(bxgi::CDATChaseFormat* pFormat) { m_pFormat = pFormat; }
	bxgi::CDATChaseFormat*		getFormat(void) { return m_pFormat; }
...
private:
	bxgi::CDATChaseFormat*		m_pFormat;
