...
public:
	...
	void							setPoints(std::vector<bxcf::CPoint2D>& vecPoints) { m_vecPoints = vecPoints; }
	std::vector<bxcf::CPoint2D>&		getPoints(void) { return m_vecPoints; }
	
private:
	std::vector<bxcf::CPoint2D>		m_vecPoints;
};
