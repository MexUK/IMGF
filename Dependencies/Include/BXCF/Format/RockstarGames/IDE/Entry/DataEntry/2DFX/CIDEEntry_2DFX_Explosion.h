...
class bxcf::CIDEEntry_2DFX_Explosion : public bxcf::CIDEEntry_2DFX
{
public:
	CIDEEntry_2DFX_Explosion(bxcf::CIDEFormat *pIDEFormat) :
		CIDEEntry_2DFX(pIDEFormat, bxcf::_2DFX_EXPLOSION),
		m_uiUnknown1(0),
		m_uiUnknown2(0),
		m_uiUnknown3(0),
		m_uiUnknown4(0)
