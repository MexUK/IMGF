...
public:
	...
	bxcf::CDATEntry_Paths_General_Header&						getHeader(void) { return m_header; }
...
private:
	...
	bxcf::eDATPathFormat										detectPathsFormat(void);

public: // todo - make this access specifier private
	uint32												m_uiFileIndex;
	bxcf::CDATEntry_Paths_General_Header						m_header;
	std::vector<bxcf::CDATEntry_Paths_General_PathNode>		m_vecPathNodes;
	std::vector<bxcf::CDATEntry_Paths_General_NaviNode>		m_vecNaviNodes;
	std::vector<bxcf::CDATEntry_Paths_General_Link>			m_vecLinks;
};
