...
#pragma pack(push, 1)
struct bxcf::CDATEntry_Paths_Default_Header
{
...
#pragma pack(push, 1)
struct bxcf::CDATEntry_Paths_Default_PathNode
{
...
#pragma pack(push, 1)
struct bxcf::CDATEntry_Paths_Default_NaviNode
{
	int16			m_iPosition[2];
	uint16			m_usAreaId;
	uint16			m_usNodeId;
...
#pragma pack(push, 1)
struct bxcf::CDATEntry_Paths_Default_Link
{
	uint16			m_usAreaId;
	uint16			m_usNodeId;
};
...
#pragma pack(push, 1)
struct bxcf::CDATEntry_Paths_Default_NaviLink
{
...
#pragma pack(push, 1)
struct bxcf::CDATEntry_Paths_Default_LinkLength
{
	uint8			m_ucLength;
};
#pragma pack(pop)
...
struct bxcf::CDATEntry_Paths_Default_Link_Wrapper
{
	uint16			m_usAreaId;
	uint16			m_usNodeId;
...
class bxcf::CompressedVector_extended
{
public:
	signed __int32 x;
	signed __int32 y;
...
struct bxcf::CNodeAddress
{
	unsigned __int16 areaId;
	unsigned __int16 nodeId;
};

struct bxcf::CDATEntry_Paths_Fastman92_Header
{
...
struct bxcf::CDATEntry_Paths_Fastman92_PathNode
{
...
struct bxcf::CDATEntry_Paths_Fastman92_PathNode_extended : public CDATEntry_Paths_Fastman92_PathNode
{
	CompressedVector_extended m_extended_posn;
};

struct bxcf::CDATEntry_Paths_Fastman92_NaviNode
{
...
struct bxcf::CDATEntry_Paths_Fastman92_NaviNode_extended : public CDATEntry_Paths_Fastman92_NaviNode
{
	signed __int32 extended_posX;
	signed __int32 extended_posY;
};

struct bxcf::CDATEntry_Paths_Fastman92_Link
{
	uint16			m_usAreaId;
	uint16			m_usNodeId;
};

struct bxcf::CDATEntry_Paths_Fastman92_NaviLink
{
	uint32			m_uiData; // lower 16 bit are the Navi Node ID, upper 16 bit the corresponding Area ID
};

struct bxcf::CDATEntry_Paths_Fastman92_LinkLength
{
	uint8			m_ucLength;
};

struct bxcf::CDATEntry_Paths_Fastman92_PathIntersectionFlags
{
...
struct bxcf::CDATEntry_Paths_General_Header
{
...
struct bxcf::CDATEntry_Paths_General_Link
{
	uint16						m_usAreaId;
	uint16						m_usNodeId;
