...
public:
	...
	void						setEntryType(bxcf::eSectionLinesEntryType eEntryType) { m_eEntryType = eEntryType; }
	bxcf::eSectionLinesEntryType		getEntryType(void) { return m_eEntryType; }
...
private:
	...
	bxcf::eSectionLinesEntryType		m_eEntryType;
