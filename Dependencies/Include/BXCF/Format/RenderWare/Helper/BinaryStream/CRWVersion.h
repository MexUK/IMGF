...
public:
	...
	void							setVersionId(bxcf::eRWVersion eVersionId) { m_eVersionId = eVersionId; }
	bxcf::eRWVersion						getVersionId(void) { return m_eVersionId; }

	void							setVersionType(bxcf::eRWVersionType eVersionType) { m_eVersionType = eVersionType; }
	bxcf::eRWVersionType					getVersionType(void) { return m_eVersionType; }
...
private:
	...
	bxcf::eRWVersionType					m_eVersionType;				// e.g. DFF
