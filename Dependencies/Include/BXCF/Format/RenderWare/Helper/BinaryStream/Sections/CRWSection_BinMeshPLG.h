...
class bxcf::CRWSection_BinMeshPLG : public bxcf::CRWSection
{
public:
	...
	std::vector<bxcf::CRWEntry_BinMeshPLG_Mesh*>&		getMeshes(void) { return m_vecMeshes; }

private:
	uint32										m_uiFlags; // 0 = triangle list, 1 = triangle strip
	uint32										m_uiMeshCount;
	uint32										m_uiIndexCount;
	std::vector<bxcf::CRWEntry_BinMeshPLG_Mesh*>		m_vecMeshes;
};
