...
class bxcf::CRWEntry_2dEffect_EnterExit : public bxcf::C2dEffect
{
public:
	...
	void							setMarkerApporximationRadius(bxcf::CVector2D& vecMarkerApporximationRadius) { m_vecMarkerApporximationRadius = vecMarkerApporximationRadius; }
	bxcf::CVector2D&						getMarkerApporximationRadius(void) { return m_vecMarkerApporximationRadius; }

	void							setExitMarkerPosition(bxcf::CVector3D& vecExitMarkerPosition) { m_vecExitMarkerPosition = vecExitMarkerPosition; }
	bxcf::CVector3D&						getExitMarkerPosition(void) { return m_vecExitMarkerPosition; }
...
private:
	...
	bxcf::CVector2D						m_vecMarkerApporximationRadius; // The radius of the approximation to the marker X and Y
	bxcf::CVector3D						m_vecExitMarkerPosition; // The position of exit - marker(offset relative to the object) (Always 0 ? )
